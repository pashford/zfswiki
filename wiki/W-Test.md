...
A subset of the full test suite can be run by the developer to perform a preliminary verification of their changes.  To run the small test suite, please follow the steps described [here][git-test].
